...
//		for(int i=0;i<area.length;i++) {
			try {
				URL	url = new URL("http://race.kra.co.kr/dbdata/fileDownLoad.do?fn=internet/seoul/jockey/20190801sdb2.txt");
//				URL	url = new URL("http://race.kra.co.kr/dbdata/fileDownLoad.do?fn=internet/"+area[i]+"/jockey/"+yyyyMMdd+db[i]+".txt");
				...
				while ((line = reader.readLine()) != null) {
					if(line.contains("-")||line.contains("기수명")) {
						...
						if(splitedStr.length !=1) {
							...
							jockeyDto.setJk_rcCntT(splitedStr[7]);
			...
			try {
				URL	url = new URL("http://race.kra.co.kr/dbdata/fileDownLoad.do?fn=internet/busan/jockey/20190731pdb2.txt");
//				URL	url = new URL("http://race.kra.co.kr/dbdata/fileDownLoad.do?fn=internet/"+area[i]+"/jockey/"+yyyyMMdd+db[i]+".txt");
				System.out.println(url);
				int jk_meet = 3;
				String[] splitedStr = null;
			...
			try {
				URL	url = new URL("http://race.kra.co.kr/dbdata/fileDownLoad.do?fn=internet/jeju/jockey/20190731cdb2.txt");
//				URL	url = new URL("http://race.kra.co.kr/dbdata/fileDownLoad.do?fn=internet/"+area[i]+"/jockey/"+yyyyMMdd+db[i]+".txt");
				System.out.println(url);
				int jk_meet = 2;
				String[] splitedStr = null;
