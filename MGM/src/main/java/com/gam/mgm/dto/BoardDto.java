...
public class BoardDto {
	...
	public BoardDto(int board_seq, int board_group, String board_title, String board_contents,
			String board_writer, int board_readcount, Date board_regdate, String board_delflag,
			String board_recommender, int board_pushnum, String board_name, int board_replyCnt) {
		super();
	...
	public String toString() {
		return "BoardDto [board_seq=" + board_seq + ", board_group=" + board_group 
				...
				+ board_pushnum + ", board_name=" + board_name + ", board_replyCnt=" + board_replyCnt + "]";
	}
