				...
				<div class="container clearfix">
					...
					<jsp:include page="../SideBar.jsp" />
						...
						<div class="col-md-12 mt-5">
							...
							<form class="nobottommargin" action="ansinser.do" method="post">
								...
								<div class="col_full">
									...
									<button class="button button-3d nomargin" type="button" onclick="location.href='answerboard.do'">목록 가기</button>
								</div>
