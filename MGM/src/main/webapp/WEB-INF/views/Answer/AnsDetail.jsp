...
<body class="stretched">
						...
						<div class="row clearfix"> 
							<div class="col-md-12 mt-5">
							 ...
							 <div class="row clearfix topmargin-sm" >
								...
								<div class="col-md-12" style="min-height: 300px;">${answerDto.answerboard_contents}</div>
							  ...
							  <c:when test="${uid.member_id == answerDto.answerboard_writer}">
									...
									<a href="#" class="button button-3d button-rounded button-red" id="Delete"><i class="icon-thumbs-up1"></i>삭제하기</a>
									</div>
								</c:when>
								<c:otherwise>  
								<div class="row clearfix" style="float: right;"> 
									<a href="#" class="button button-3d button-rounded button-red" id="ansReply" ><i class="icon-thumbs-up1" ></i>답글달기</a>
									<a href="#" class="button button-3d button-rounded button-red" id="back" ><i class="icon-thumbs-up1" ></i>목록가기</a>
								</div>
								</c:otherwise>
								</c:choose>	
						</div>
	...
	$("#Delete").click(function(){
		...
		var answerboard_seq = $("#answerboard_seq").attr("data-answerboardseq");
		if(confirm("삭제하시겠습니까?")){
			location.href = "ansDelete.do?answerboard_seq="+answerboard_seq;				
		}
	});
	$("#back").click(function(){
			location.href = "answerboard.do?pagenum=1&contentnum=20";				
		
	});
	$("#ansReply").click(function(){
		var answerboard_seq = $("#answerboard_seq").attr("data-answerboardseq");
			location.href = "answerboardReply.do?answerboard_seq="+answerboard_seq;					
	});
	</script> 
	</body>
	</html>