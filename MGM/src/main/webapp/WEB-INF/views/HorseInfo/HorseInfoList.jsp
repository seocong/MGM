									...
									<div id="container" class="nomargin">
										...
										<div>
											...
											<h4 class="mb-3 mt-3 ls1 uppercase t700" style="font-size: 100%;float: left;">
												...
												<td>마명입력</td>
												<td>
													<form class="form-inline my-2 my-lg-0" action="horseInfoList.do">
														<input class="form-control mr-sm-2" type="text" name="hr_name" placeholder="Search" aria-label="Search">
														<input type="hidden" value="${hr_meet}" name="hr_meet">
													...
													<table class="table table-bordered table-striped tableColor">
														...
														<tbody>
															...
															<c:forEach items="${rankList}" var="rankList">
																<tr>
																	<td style="text-align: center;"><a href="horseDetail.do?hr_htName=${rankList.hr_htName}&hr_meet=${rankList.hr_meet}">${rankList.hr_htName}</a></td>
																	...
																	<td style="text-align: center;">${rankList.recentRcDate}</td>
