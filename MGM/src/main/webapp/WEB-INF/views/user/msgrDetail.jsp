					...
					<div class="col-lg-12">
						...
						<div class="col-md-12 mt-3">
							<h4 class="mb-2 ls1 uppercase t700" style="font-size: 120%;">
								<span class="text-dark"><i class="icon-email"></i>&nbsp;받은쪽지 상세보기</span>
							</h4>
							<div class="line line-xs line-sports"></div>
						</div>
						<div class="col-md-12 mt-3">
							<span class="text-dark t700 uppercase">발신인: </span><span>${message.message_sender}</span>
						</div>
						<div class="col-md-12 mt-3">
						...
						<div><button class="mypageBtn mt-2 mr-2" onclick="msgDel('${message.message_seq}','r')">삭제</button></div>
						</div>
