		...
		<section id="content">
			...
			<div class="content-wrap nopadding" >
				...
				<div class="container clearfix">
					...
					<td  style="text-align: center;"><a href="ytDetail.do?ytNum=${YoutubeDto.ytNum}&pagenum=${page.pagenum+1}&contentnum=10"><img src="http://img.youtube.com/vi/${YoutubeDto.ytAddress}/0.jpg"></a></td>				
					<td  style="text-align: center;"><a href="ytDetail.do?ytNum=${YoutubeDto.ytNum}&pagenum=${page.pagenum+1}&contentnum=10">${YoutubeDto.ytTitle}</a></td>
