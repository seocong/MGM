				...
				<div class="container clearfix">
					...
					<jsp:include page="../SideBar.jsp" />
						...
						<h4 class="mb-2 ls1 uppercase t700 topmargin" style="font-size: 150%;">
										...
										블랙잭<span style="font-size: 60%;"></span>
									</h4>
								...
								<div class="card border">
									...
									<div class="entry-image nomargin">
												<iframe style="width: 100%; height: 550px; overflow: hidden;" src="https://playpager.com/play-blackjack/index.html" scrolling="no"> </iframe>
											</div>
										
									</article>
									<div><h4 class="mb-2 ls1 uppercase t700 " style="font-size: 150%;"><i class="icon-line-play"></i>게임방법</h4></div>
									<div>카드의 합이 딜러보다 먼저 21이 되거나 딜러보다 21에 가깝게 되면 이기고, 카드를 더 받았는데 21을 초과하면 버스트(Bust)된다.</div>
									<div>받은 카드 두 장의 합이 21에 못 미치면 히트(Hit)라고 말한 뒤 한 장씩 더 받을 수 있고, 멈추려면 스탠드(Stand)라고 말한다.</div>
									<div>딜러는 카드의 합이 16 이하면 무조건 한 장을 더 받아야 하고, 17 이상의 경우에는 멈추어야 한다.</div>
									<div>에이스 카드는 1이나 11로 취급할 수 있고, 10, J, Q, K는 모두 10으로 계산한다.</div>
