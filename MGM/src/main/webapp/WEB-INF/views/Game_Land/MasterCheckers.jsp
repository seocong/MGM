				...
				<div class="container clearfix">
					...
					<jsp:include page="../SideBar.jsp" />
						...
						<h4 class="mb-2 ls1 uppercase t700 topmargin" style="font-size: 150%;">
										...
										마스터 체커스<span style="font-size: 60%;"></span>
									</h4>
								...
								<div class="card border">
									...
									<div class="entry-image nomargin">
												<iframe style="width: 100%; height: 550px; overflow: hidden;" src="https://playpager.com/embed/checkers/index.html" scrolling="no"> </iframe>
											</div>
										
									</article>
									<div><h4 class="mb-2 ls1 uppercase t700 " style="font-size: 150%;"><i class="icon-line-play"></i>게임방법</h4></div>
									<div>한 턴당 한 번씩 대각선으로 돌을 움직일수 있습니다.</div>
									<div>상대방의 돌 위를 넘어가면 그 돌을 제거할 수 있습니다.</div>
									<div>연속으로 상대방의 돌을 제거 할 수 있습니다.</div>
