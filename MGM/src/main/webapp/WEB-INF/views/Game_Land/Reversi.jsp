				...
				<div class="container clearfix">
					...
					<jsp:include page="../SideBar.jsp" />
						...
						<h4 class="mb-2 ls1 uppercase t700 topmargin" style="font-size: 150%;">
										...
										리버시<span style="font-size: 60%;"></span>
									</h4>
								...
								<div class="card border">
									...
									<div class="entry-image nomargin">
												<iframe style="width: 100%; height: 550px; overflow: hidden;" src="https://playpager.com/embed/reversi/index.html"scrolling="no"> </iframe>
											</div>
										
									</article>
									<div><h4 class="mb-2 ls1 uppercase t700 " style="font-size: 150%;"><i class="icon-line-play"></i>게임방법</h4></div>
									<div>자신의 말을 놓았을때 대각선 혹은 가로 세로 안에 자신의 말 사이에 놓여있는 다른 색깔의 말들을 자신의 색깔로 뒤집니다.</div>
									<div>수를 놓았을때 돌들이 여러방향으로 있으면 모두 뒤집힌다.</div>
									<div>반드시 상대방의 돌을 리버시 시킬수 있는 자리에 내 돌을 놓아야한다.</div>
									<div>돌을 놓을 곳이 없을 경우 상대방에게 턴이 돌아간다(패스).</div>
