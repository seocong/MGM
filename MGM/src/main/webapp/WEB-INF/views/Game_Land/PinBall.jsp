				...
				<div class="container clearfix">
					...
					<jsp:include page="../SideBar.jsp" />
						...
						<h4 class="mb-2 ls1 uppercase t700 topmargin" style="font-size: 150%;">
										...
										핀볼<span style="font-size: 60%;"></span>
									</h4>
								...
								<div class="card border">
									...
									<div class="entry-image nomargin">
												<iframe style="width: 100%; height: 550px; overflow: hidden;" src="https://playpager.com/play-pinball/index.html" scrolling="no"> </iframe>
											</div>
										
									</article>
									<div><h4 class="mb-2 ls1 uppercase t700 " style="font-size: 150%;"><i class="icon-line-play"></i>게임방법</h4></div>
									<div>방향키로 조작하여 게임을 즐기십시오.</div>
