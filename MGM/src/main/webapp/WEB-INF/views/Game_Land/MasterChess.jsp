					...
					<jsp:include page="../SideBar.jsp" />
						...
						<h4 class="mb-2 ls1 uppercase t700 topmargin" style="font-size: 150%;">
								...
								<div class="card border">
									...
									<!-- <div>6개의 말인 킹,퀸,룩,비숍,나이트,폰을 이용해 킹을 잡거나 벗어날수 없는 상황을 만들면 승리합니다.</div> -->
									<div>두 가지 플레이 버튼 중 왼쪽(모니터모양)을 누르면 2인용 플레이 혹은 컴퓨터와 플레이 중 하나를 선택할 수 있습니다.</div>
									<div>주사위의 숫자가 높아질수록 컴퓨터와의 체스 대전에서 난이도가 증가합니다.</div>
