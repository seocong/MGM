							...
							<div class="col-md-12 mt-5">
							 ...
							 <div class="row clearfix topmargin-sm" >
								...
								<div class="row clearfix" style="float: right;"> 
									<a href="proupdate.do?board_seq=${dto.board_seq}" class="button button-3d button-rounded button-red"><i class="icon-thumbs-up1"></i>수정하기</a>
									<a href="proboard.do?pagenum=1&contentnum=20" class="button button-3d button-rounded button-red"><i class="icon-thumbs-up1"></i>목록가기</a>
								</div> 
