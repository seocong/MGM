			...
			<div class="content-wrap nopadding" >
				...
				<div class="container clearfix">
					...
					<jsp:include page="../SideBar.jsp" />
						...
						<h4 class="mb-2 ls1 uppercase t700" style="font-size: 120%;"><span class="text-dark"><i class="icon-sign"></i></span> 전문가 예상</h4>
						...
						<div class="form-widget">
							...
							<form class="nobottommargin" id="frm" action="prowrite.do" method="post">
								 <input type="hidden" name="board_name" value="pro">
								...
								<div class="col_full">
									...
									<button class="button button-3d nomargin" type="button" onclick="location.href='proboard.do?pagenum=1&contentnum=20'">목록 가기</button>
								</div>
