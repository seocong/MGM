						...
						<div class="form-widget">
							...
							<form class="nobottommargin" id="frm" action="write.do" method="post">
								...
								<div class="col_two_third">
									...
									<input type="text" id="template-contactform-subject" name="board_title" value="${boardDto.board_title}" class="required sm-form-control required" />
								</div>

								<div class="col_one_third col_last">
								<label for="template-contactform-name">작성자<small>*</small></label>
									<input type="text" id="template-contactform-name" name="board_writer" value="${boardDto.board_writer}" class="sm-form-control required" readonly="readonly"/>
								...
								<div class="col_full">
									...
									<textarea name="smarteditor" id="smarteditor" rows="21" cols="30"  style="width:100%;">${boardDto.board_contents}</textarea>
								</div>
								...
								<div class="col_full">
									...
									<button class="button button-3d nomargin" type="button" onclick="location.href='freeboard.do?board_name=${boardDto.board_name}'">목록 가기</button>
								</div>
