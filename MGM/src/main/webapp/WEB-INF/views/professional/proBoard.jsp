				...
				<div class="container clearfix">
					...
					<jsp:include page="../SideBar.jsp" />
						...
						<div id="container" >
							...
							<ul class="tab">
								<li id="tabproboard"><a href="proboard.do?pagenum=1&contentnum=20" > 전체 전문가분석</a></li>
								<li id="tabprolist"><a href="proProfile.do" > 프레임 전문가 보기</a></li>
							</ul>
							<c:if test="${board_name eq 'pro'}">
							<div>
						...
						<c:otherwise>    
					        ...
					        <a href="prodetail.do?board_seq=${boardDto.board_seq}&pagenum=${page.pagenum+1}&contentnum=20">${boardDto.board_title}
        ...
        <td>
                ...
                <div class="col-md-12">
                  <input type="button" value="글쓰기" onclick="location.href='proinsertform.do?board_name=${board_name}'">
						...
						<c:if test="${board_name eq 'proProfile'}">
						<div>
							<div class="tabcontent" id="tab4">
									...
									<c:forEach items="${profileList}" var="list">
										<div class="col-md-4 mb-4">
											<a href="#">
												...
												<div class="card-body pb-0 mb-1 row clearfix">
												<img src="resources/images/proImg/${list.pro_id}.gif" style="width:140px;">
												<div class="ml-1 col-md-6">
													<span style="font-weight:bold; font-size: 18px; color:#3A486E;">${list.pro_name}</span><br>
													<div class="mt-1 col-md-12" style="color:#898989; font-size: 12px;">${list.pro_simple}</div>
												</div>
												</div>
												<div>
													<div style="background-color: #DDD;" >
														<span style="background-color: #3A486E; font-size: 12px; color:white; font-weight: bold; border-radius:5px;">&nbsp;문자&nbsp;</span>
														&nbsp;&nbsp;
														<span style="font-size:12px; color:black; font-weight:bold;">010-6125-1565</span>
													</div>
												</div>
												</div>
